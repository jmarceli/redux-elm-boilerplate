  ...
  return (
    <ListGroup className={className}>
      <ListGroupItem header="Quick scaffolding">
        Automate the creation of components, containers, routes, selectors and
        sagas - and their tests - right from the CLI!
      </ListGroupItem>
      ...
      <ListGroupItem header="Next generation CSS">
        ...
        Unique generated class names keep the specificity low while eliminating style clashes.
        Ship only the styles that are on the page for the best performance.
      </ListGroupItem>
      <ListGroupItem header="Industry-standard routing">
        It's natural to want to add pages (e.g. `/about`) to your application, and routing
        makes this possible.
      </ListGroupItem>
      <ListGroupItem header="Offline-first">
        The next frontier in performant web apps: availability without a network connection
        from the instant your users load the app.
      </ListGroupItem>
